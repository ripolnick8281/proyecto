    ...
    <main id="fondo1" class="app-content">
      <div id="fondotitulo" class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="">Asignacion</a></li>
        </ul>
      </div>    
         ...
         <?php
                           ...
                           echo form_open_multipart('asignacion/modificarasignacionbd',$atributos);
                           foreach ($infoasignacion->result() as $row)
                           {
                           ?>
            <div class="col-md-8">
            <div class="tile">
            <h3 class="tile-title">Modifica Asignacion</h3>
            <div class="tile-body">
            <input type="hidden" name="id" value="<?php echo $row->idAsignacion; ?>"> 
               ...
               <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="provincia" type="text" placeholder="Ingrese la provincia" required="" onkeypress="return SoloLetras(event);" required value="<?php echo $row->provincia ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-4">Descripcion de la zona</label>
                  <div class="col-md-8">
                    <input class="form-control" name="descripcion" type="text" placeholder="Ingrese la descripcion de la zona" required="" onkeypress="return SoloLetras(event);" required value="<?php echo $row->descripcion ?>">
                  </div>
                </div>
