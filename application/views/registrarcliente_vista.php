        ...
        <ul class="app-breadcrumb breadcrumb">
         ...
         <div class="container">
                         ...
                         <?php
                           ...
                           echo form_open_multipart('cliente/registrarclientebd',$atributos)?>
            <div class="col-md-8">
            <div class="tile">
            ...
            <div class="tile-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="nombrecliente" type="text" placeholder="Ingrese el Nombre" required="" onkeypress="return SoloLetras(event);" required >
                  </div>
                </div>
