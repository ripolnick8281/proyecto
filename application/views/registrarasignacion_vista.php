        ...
        <ul class="app-breadcrumb breadcrumb">
         ...
         <div class="container">
                         ...
                         <?php
                           ...
                           echo form_open_multipart('asignacion/registrarasignacionbd',$atributos)?>
            <div class="col-md-8">
            <div class="tile">
            <h3 class="tile-title">Registro De asignacion</h3>
            <div class="tile-body">
            
               <div class="form-group row">
                  <label class="control-label col-md-4">Provincia</label>
                  <div class="col-md-8">
                    <input class="form-control" name="provincia" type="text" placeholder="Ingrese la provincia" required="" onkeypress="return SoloLetras(event);" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-4">Descripcion de la zona</label>
                  <div class="col-md-8">
                    <input class="form-control" name="descripcion" type="text" placeholder="Ingrese la descripcion de la zona" required="" onkeypress="return SoloLetras(event);" required>
                  </div>
                </div>
