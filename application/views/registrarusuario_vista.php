        ...
        <ul class="app-breadcrumb breadcrumb">
         ...
         <div class="container">
                         ...
                         <?php
                           ...
                           echo form_open_multipart('usuario/registrarusuariobd',$atributos)?>
            <div class="col-md-8">
            <div class="tile">
            ...
            <div class="tile-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="nombreusuario" type="text" placeholder="Ingrese el Nombre" required="" onkeypress="return SoloLetras(event);" required >
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="primerapellido" type="text" placeholder="Ingrese el Primer Apellido" required="" onkeypress="return SoloLetras(event);" required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="segundoapellido" type="text" placeholder="Ingrese el Segundo Apellido " required="" onkeypress="return SoloLetras(event);" required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="ci" type="text" placeholder="Ingrese su CI." required="" >
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="animated-checkbox">
                    <label>
                      <input name="sexo" value="M" type="checkbox"><span  class="label-text">M</span>
                    </label>
                   </div>
                    <div class="animated-checkbox">
                     <label>
                      <input  name="sexo" value="F"  type="checkbox"><span class="label-text">F</span>
                     </label>
                    </div>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="telefono" type="text" placeholder="Ingrese el numero de Telefono " required="" onkeypress="return SoloNumeros(event);" required>
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="login" type="text" placeholder="Ingrese un login" required="" >
                  </div>
                </div>
                <div class="form-group row">
                ...
                <label class="control-label col-md-4">Seleccione Un tipo de Usuario</label>
                    <select name="tipousuario" class="form-control" id="exampleSelect1">
