    ...
    <aside id="menu2" class="app-sidebar">
      ...
      <ul id="menu1" class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label"> Registrar</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          ...
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="<?php echo base_url(); ?>index.php/usuario/registrarusuario"><i class="icon fa fa-circle-o"></i> Form Components</a></li>
    ...
    <main id="fondo1" class="app-content">
      <div id="fondotitulo" class="app-title">
        <div id="contenedortitulo">
          <h1 id="titulo1" ><i class="fa fa-dashboard"></i>Lista Usuarios</h1>
          <p></p>
        </div>
            ...
            <div id="colorform" class="tile-body">
              <div id="colorform2" class="table-responsive">
                      ...
                      <tr>
                        ...
                        <td><?php echo $row->fechaActualizacion; ?></td>
                         <td>
                           ...
                           echo form_open_multipart('usuario/modificarusuario',$atributos)?>
                         ...
                         <td>
                           <?php
                           $atributos = array('class' => 'form-group', 'id' => 'myform');
                           echo form_open_multipart('usuario/eliminarusuario',$atributos)?>
                           <input type="hidden" name="id" value="<?php echo $row->idUsuario; ?>">
                ...
                <?php 
                 ...
                 echo form_open_multipart('usuario/registrarusuario', $atributos); ?>
                 <button type="submit" class= "btn btn-info btn">Agregar Usuario</button>
                 <?php
                 echo form_close();
                ?>
              </div>
