    ...
    <main id="fondo1" class="app-content">
      <div id="fondotitulo" class="app-title">
        <div id="contenedortitulo">
          <h1 id="titulo1" ><i class="fa fa-dashboard"></i>Lista Clientes</h1>
          <p></p>
        </div>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row->tipoUsuario; ?> </td>
                         <td>
                           ...
                           echo form_open_multipart('cliente/modificarcliente',$atributos)?>
                         ...
                         <td>
                           <?php
                           $atributos = array('class' => 'form-group', 'id' => 'myform');
                           echo form_open_multipart('cliente/eliminarcliente',$atributos)?>
                           <input type="hidden" name="id" value="<?php echo $row->idCliente; ?>">
