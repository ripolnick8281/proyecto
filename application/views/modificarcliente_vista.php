        ...
        <ul class="app-breadcrumb breadcrumb">
         ...
         <div class="container">
                        ...
                        <?php
                           ...
                           echo form_open_multipart('cliente/modificarbd',$atributos);
                           foreach ($infocliente->result() as $row)
                           {
                           ?>
            <div class="col-md-8">
            <div class="tile">
            <h3 class="tile-title">Modificar Cliente</h3>
            <div class="tile-body">
            
            <input type="hidden" name="id" value="<?php echo $row->idCliente; ?>">

                <div class="form-group row">
                  <label class="control-label col-md-4">Nombre de Cliente</label>
                  <div class="col-md-8">
                    <input class="form-control" name="nombrecliente" type="text" placeholder="Ingrese el Nombre" required="" value="<?php echo $row->nombres;?>" >
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="primerapellido" type="text" placeholder="Ingrese el Primer Apellido" value="<?php echo $row->primerApellido;?>"required="" >
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="direccion" type="text" placeholder="Direccion" required="" value="<?php echo $row->direccion;?>" >
                  </div>
                </div>
