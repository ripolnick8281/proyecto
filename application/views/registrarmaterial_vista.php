        ...
        <ul class="app-breadcrumb breadcrumb">
         ...
         <div class="container">
                         ...
                         <?php
                           ...
                           echo form_open_multipart('material/registrarmaterialbd',$atributos)?>
            <div class="col-md-8">
            <div class="tile">
            <h3 class="tile-title">Registro De Material</h3>
            <div class="tile-body">
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                  <select name="descripcion" class="form-control" id="exampleSelect1">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="unidades" type="text"  required="" onkeypress="return SoloNumeros(event);" required>
                  </div>
                  </div>
                </div>
