        ...
        <ul class="app-breadcrumb breadcrumb">
         ...
         <div class="container">
                         ...
                         <?php
                           ...
                           echo form_open_multipart('transaccionmaterial/agregarDetalle',$atributos)?>
            <div class="col-md-8">
            <div class="tile">
            <h3 class="tile-title">Despacho de Material</h3>
            <div class="tile-body">
                ...
                <div class="form-group row">
                  <label class="control-label col-md-4">PrimerApellido</label>
                  <div class="col-md-8">
                    <input class="form-control" name="primerapellido" type="text" placeholder="" required="">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                  <select name="nombrematerial" class="form-control" id="exampleSelect1">
                  ...
                  <div class="col-md-8">
                  <select name="medida" class="form-control" id="exampleSelect1">
                ...
                <div class="form-group row">
                  <label class="control-label col-md-4">Cantidad a entregar</label>
                  <div class="col-md-8">
                    <input class="form-control" name="unidades" type="text" placeholder="" required="">
                  </div>
                </div>
            ...
            <div class="tile-footer">
              <div class="row">
                <div class="col-md-8 col-md-offset-3">
                  <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Añadir</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div id="colorform" class="tile-body">
              <div id="colorform2" class="table-responsive">
                      ...
                      <tr>
                        ...
                        <td><?php echo $row->fechaEntrega; ?> </td>
                         ...
                         <td>
                           <?php
                           $atributos = array('class' => 'form-group', 'id' => 'myform');
                           echo form_open_multipart('transaccionmaterial/getid2/eliminardetalle',$atributos)?>
                           <input type="hidden" name="id" value="<?php echo $row->idDetalleEntrega; ?>">
                           <input type="hidden" name="nombrematerial" value="<?php echo $row->nombre; ?>">
                           <input type="hidden" name="unidadmaterial" value="<?php echo $row->unidades; ?>">
                           <button  type="submit" class="btn btn-success btn">recuperar</button>
                            <?php echo form_close(); ?>
                         </td>
                      </tr>
                     <?php
                ...
                <?php
                           ...
                           <input type="hidden" name="limpiar" value="2">
