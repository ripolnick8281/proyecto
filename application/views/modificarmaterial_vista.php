      ...
      <ul id="menu1" class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Listar</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="<?php echo base_url(); ?>index.php/asignacion/listaasignacion"><i class="icon fa fa-circle-o"></i> Asignacion</a></li>
        ...
        <ul class="app-breadcrumb breadcrumb">
         ...
         <div class="container">
                         ...
                         <?php
                           ...
                           echo form_open_multipart('material/modificarmaterialbd',$atributos);
                           foreach ($infomaterial->result() as $row)
                           {
                           ?>
            <div class="col-md-8">
            <div class="tile">
            <h3 class="tile-title">Modificar Material</h3>
            <div class="tile-body">

            <input type="hidden" name="id" value="<?php echo $row->idMaterialDeInstalacion; ?>">
            
            <div class="form-group row">
                  <label class="control-label col-md-4">Nombre del Material</label>
                  <div class="col-md-8">
                  <select name="nombrematerial" class="form-control" id="exampleSelect1" value="<?php echo $row->nombre ?>">
                  <option>Abrazadera Acerada</option>
                      <option>Barrilla de Bronce</option>
                      <option>Codo Galvanizado Tupi</option>
                      <option>Codo Galvanizado Reductor</option>
                      <option>Codo Galvanizado HM</option>
                      <option>Cupla Galvanizada</option>
                      <option>Clavos</option>
                      <option>Cinta Teflón</option>
                      <option>Cinta Type</option>
                      <option>Piton Conector Hembra</option>
                      <option>Piton Conector Macho</option>
                      <option>Pintura Amarrilla Anticorrosiva </option>
                      <option>Tubería Galvanizada Esquema 40 </option>
                      <option>Tornillo de Encarne</option>
                      <option>Tacos de Madera</option>
                      <option>Tapon Galbanizado</option>
                      <option>Tubo Funda PVC</option>
                      <option>Valvula Galvanizada</option>
                      <option>Valvula Galvanizada FV</option>
                      <option>Amoladora</option>
                      <option>Alicate</option>
                      <option>Broca Concreto</option>
                      <option>Botellon de Oxígeno</option>
                      <option>Cincel</option>
                      <option>Desarmador</option>
                      <option>Disco de corte Mediano</option>
                      <option>Disco de corte Pequeño</option>
                      <option>Flexómetro</option>
                      <option>Gasómetro</option>
                      <option>Llave Crecen</option>
                      <option>Llave Stillson</option>
                      <option>Martillo</option>
                      <option>Nivel</option>
                      <option>Rotomartillo</option>
                      <option>Sierra Mecanica</option>
                  ...
                  <div class="col-md-8">
                  <select name="medida" class="form-control" id="exampleSelect1" value="<?php echo $row->medida ?>">
                  <option>1 Pulgada</option>
                      <option>3/4 de Pulgada</option>
                      <option>1/2 de Pulgada</option>
                      <option>9 Milímetros</option>
                      <option>Barra</option>
                ...
                <div class="form-group row">
                  <label class="control-label col-md-4">Descripcion del Material</label>
                  <div class="col-md-8">
                  <select name="descripcion" class="form-control" id="exampleSelect1" value="<?php echo $row->descripcion ?>">
                      <option>Material de Intalacion</option>
                      <option>Herrmienta de Instalacion</option>
                    </select>
                  </div>
                </div>
      
                <div class="form-group row">
                  <label class="control-label col-md-4">Unidades</label>
                  <div class="col-md-8">
                    <input class="form-control" name="unidades" type="text"  required="" onkeypress="return SoloNumeros(event);" required value="<?php echo $row->unidades ?>">
                  </div>
                  </div>
                </div>
