    ...
    <main id="fondo1" class="app-content">
      <div id="fondotitulo" class="app-title">
        <div id="contenedortitulo">
          <h1 id="titulo1" ><i class="fa fa-dashboard"></i>Lista Material de Trabajo</h1>
          <p></p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Listar</li>
          <li class="breadcrumb-item active"><a href="">Material</a></li>
        </ul>
      </div>
            ...
            <div id="colorform" class="tile-body">
              <div id="colorform2" class="table-responsive">
                      ...
                      <tr>
                        ...
                        <td><?php echo $row->login; ?> </td>
                         ...
                         <td>
                           ...
                           echo form_open_multipart('material/modificarmaterial',$atributos)?>
                         ...
                         <td>
                           <?php
                           $atributos = array('class' => 'form-group', 'id' => 'myform');
                           echo form_open_multipart('material/eliminarmaterial',$atributos)?>
                           <input type="hidden" name="id" value="<?php echo $row->idMaterialDeInstalacion; ?>">
                ...
                <?php 
                 ...
                 echo form_open_multipart('material/registrarmaterial', $atributos); ?>
                 <button type="submit" class= "btn btn-info btn">Agregar Material</button>
                 <?php
                 echo form_close();
                ?>
              </div>
